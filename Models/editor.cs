...
/// </para>
/// </summary>
public partial class Editor : XTypedElement, IXMetaData
{
  ...
  public static Editor Load(string xmlFile)
  {
    return XTypedServices.Load<Editor>(xmlFile);
  }

  public static Editor Load(System.IO.TextReader xmlFile)
  {
    return XTypedServices.Load<Editor>(xmlFile);
  }

  public static Editor Parse(string xml)
  {
    return XTypedServices.Parse<Editor>(xml);
  }

  public static explicit operator Editor(XElement xe) { return XTypedServices.ToXTypedElement<Editor>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }

  public override XTypedElement Clone()
  {
    return XTypedServices.CloneXTypedElement<Editor>(this);
  }
  ...
  private static readonly System.Xml.Linq.XName XName = System.Xml.Linq.XName.Get("editor", "");
