...
/// </para>
/// </summary>
public partial class Director : XTypedElement, IXMetaData
{
  ...
  public static Director Load(string xmlFile)
  {
    return XTypedServices.Load<Director>(xmlFile);
  }

  public static Director Load(System.IO.TextReader xmlFile)
  {
    return XTypedServices.Load<Director>(xmlFile);
  }

  public static Director Parse(string xml)
  {
    return XTypedServices.Parse<Director>(xml);
  }

  public static explicit operator Director(XElement xe) { return XTypedServices.ToXTypedElement<Director>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }

  public override XTypedElement Clone()
  {
    return XTypedServices.CloneXTypedElement<Director>(this);
  }
  ...
  private static readonly System.Xml.Linq.XName XName = System.Xml.Linq.XName.Get("director", "");
