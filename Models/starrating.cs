...
/// </para>
/// </summary>
public partial class Starrating : XTypedElement, IXMetaData
{
  ...
  public static Starrating Load(string xmlFile)
  {
    return XTypedServices.Load<Starrating>(xmlFile);
  }

  public static Starrating Load(System.IO.TextReader xmlFile)
  {
    return XTypedServices.Load<Starrating>(xmlFile);
  }

  public static Starrating Parse(string xml)
  {
    return XTypedServices.Parse<Starrating>(xml);
  }

  public static explicit operator Starrating(XElement xe) { return XTypedServices.ToXTypedElement<Starrating>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }

  public override XTypedElement Clone()
  {
    return XTypedServices.CloneXTypedElement<Starrating>(this);
  }
  ...
  private static readonly System.Xml.Linq.XName XName = global::System.Xml.Linq.XName.Get("star-rating", "");
