...
/// </para>
/// </summary>
public partial class Guest : XTypedElement, IXMetaData
{
  ...
  public static Guest Load(string xmlFile)
  {
    return XTypedServices.Load<Guest>(xmlFile);
  }

  public static Guest Load(System.IO.TextReader xmlFile)
  {
    return XTypedServices.Load<Guest>(xmlFile);
  }

  public static Guest Parse(string xml)
  {
    return XTypedServices.Parse<Guest>(xml);
  }

  public static explicit operator Guest(XElement xe) { return XTypedServices.ToXTypedElement<Guest>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }

  public override XTypedElement Clone()
  {
    return XTypedServices.CloneXTypedElement<Guest>(this);
  }
  ...
  private static readonly System.Xml.Linq.XName XName = System.Xml.Linq.XName.Get("guest", "");
