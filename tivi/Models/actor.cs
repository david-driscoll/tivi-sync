...
/// </para>
/// </summary>
public partial class Actor : XTypedElement, IXMetaData
{
  ...
  public static Actor Load(string xmlFile)
  {
    return XTypedServices.Load<Actor>(xmlFile);
  }

  public static Actor Load(System.IO.TextReader xmlFile)
  {
    return XTypedServices.Load<Actor>(xmlFile);
  }

  public static Actor Parse(string xml)
  {
    return XTypedServices.Parse<Actor>(xml);
  }

  public static explicit operator Actor(XElement xe) { return XTypedServices.ToXTypedElement<Actor>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }

  public override XTypedElement Clone()
  {
    return XTypedServices.CloneXTypedElement<Actor>(this);
  }
  ...
  [DebuggerBrowsable(DebuggerBrowsableState.Never)]
  [EditorBrowsable(EditorBrowsableState.Never)]
  protected internal static readonly System.Xml.Linq.XName RoleXName = System.Xml.Linq.XName.Get("role", "");
  ...
  /// </para>
  /// </summary>
  public virtual GuestEnum? Guest
  {
    get
    {
      XAttribute x = this.Attribute(GuestXName);
      if ((x == null))
      {
        return null;
      }
      return ((GuestEnum)(Enum.Parse(typeof(GuestEnum), XTypedServices.ParseValue<string>(x, XmlSchemaType.GetBuiltInSimpleType(XmlTypeCode.Token).Datatype))));
    }
    set
    {
      this.SetAttribute(GuestXName, value?.ToString(), XmlSchemaType.GetBuiltInSimpleType(XmlTypeCode.Token).Datatype);
    }
  }

  private static readonly System.Xml.Linq.XName XName = System.Xml.Linq.XName.Get("actor", "");
