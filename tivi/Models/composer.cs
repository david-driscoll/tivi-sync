...
/// </para>
/// </summary>
public partial class Composer : XTypedElement, IXMetaData
{
  ...
  public static Composer Load(string xmlFile)
  {
    return XTypedServices.Load<Composer>(xmlFile);
  }

  public static Composer Load(System.IO.TextReader xmlFile)
  {
    return XTypedServices.Load<Composer>(xmlFile);
  }
  ...
  {
    return XTypedServices.Parse<Composer>(xml);
  }

  public static explicit operator Composer(XElement xe) { return XTypedServices.ToXTypedElement<Composer>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }

  public override XTypedElement Clone()
  {
    return XTypedServices.CloneXTypedElement<Composer>(this);
  }
  ...
  private static readonly System.Xml.Linq.XName XName = System.Xml.Linq.XName.Get("composer", "");
