...
/// </para>
/// </summary>
public partial class Commentator : XTypedElement, IXMetaData
{
  ...
  public static Commentator Load(string xmlFile)
  {
    return XTypedServices.Load<Commentator>(xmlFile);
  }

  public static Commentator Load(System.IO.TextReader xmlFile)
  {
    return XTypedServices.Load<Commentator>(xmlFile);
  }

  public static Commentator Parse(string xml)
  {
    return XTypedServices.Parse<Commentator>(xml);
  }

  public static explicit operator Commentator(XElement xe) { return XTypedServices.ToXTypedElement<Commentator>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }

  public override XTypedElement Clone()
  {
    return XTypedServices.CloneXTypedElement<Commentator>(this);
  }
  ...
  private static readonly System.Xml.Linq.XName XName = System.Xml.Linq.XName.Get("commentator", "");
