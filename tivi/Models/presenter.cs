...
/// </para>
/// </summary>
public partial class Presenter : XTypedElement, IXMetaData
{
  ...
  public static Presenter Load(string xmlFile)
  {
    return XTypedServices.Load<Presenter>(xmlFile);
  }

  public static Presenter Load(System.IO.TextReader xmlFile)
  {
    return XTypedServices.Load<Presenter>(xmlFile);
  }

  public static Presenter Parse(string xml)
  {
    return XTypedServices.Parse<Presenter>(xml);
  }

  public static explicit operator Presenter(XElement xe) { return XTypedServices.ToXTypedElement<Presenter>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }

  public override XTypedElement Clone()
  {
    return XTypedServices.CloneXTypedElement<Presenter>(this);
  }
  ...
  private static readonly System.Xml.Linq.XName XName = System.Xml.Linq.XName.Get("presenter", "");
