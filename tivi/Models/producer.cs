...
/// </para>
/// </summary>
public partial class Producer : XTypedElement, IXMetaData
{
  ...
  public static Producer Load(string xmlFile)
  {
    return XTypedServices.Load<Producer>(xmlFile);
  }

  public static Producer Load(System.IO.TextReader xmlFile)
  {
    return XTypedServices.Load<Producer>(xmlFile);
  }

  public static Producer Parse(string xml)
  {
    return XTypedServices.Parse<Producer>(xml);
  }

  public static explicit operator Producer(XElement xe) { return XTypedServices.ToXTypedElement<Producer>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }

  public override XTypedElement Clone()
  {
    return XTypedServices.CloneXTypedElement<Producer>(this);
  }
  ...
  private static readonly System.Xml.Linq.XName XName = System.Xml.Linq.XName.Get("producer", "");
